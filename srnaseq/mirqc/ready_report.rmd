...
kable(isoSelect(obj_other, mirna="hsa-let-7a-5p", minc=1)[,grepl("MS", rownames(design_other))])

kable(isoSelect(obj_other, mirna="hsa-let-7b-5p", minc=1)[,grepl("MS", rownames(design_other))])

kable(isoSelect(obj_other, mirna="hsa-let-7c-5p", minc=1)[,grepl("MS", rownames(design_other))])

kable(isoSelect(obj_other, mirna="hsa-let-7d-5p", minc=1)[,grepl("MS", rownames(design_other))])

mirnas = c("hsa-let-7a-5p", "hsa-let-7b-5p", "hsa-let-7c-5p", "hsa-let-7d-5p")
ma = log2(counts(obj_other)[mirnas, grepl("MS", rownames(design_other))] + 0.25)
pheatmap(ma)
```

```{r detection-serum-liver, results="asis"}

kable(isoSelect(obj_other, mirna="hsa-miR-302a-3p", minc=1)[,grepl("liver", rownames(design_other))])

kable(isoSelect(obj_other, mirna="hsa-miR-302b-3p", minc=1)[,grepl("liver", rownames(design_other))])

kable(isoSelect(obj_other, mirna="hsa-miR-302c-3p", minc=1)[,grepl("liver", rownames(design_other))])

kable(isoSelect(obj_other, mirna="hsa-miR-302d-3p", minc=1)[,grepl("liver", rownames(design_other))])

mirnas = c("hsa-miR-302a-3p", "hsa-miR-302b-3p", "hsa-miR-302c-3p", "hsa-miR-302d-3p")
ma = log2(counts(obj_other)[mirnas, grepl("liver", rownames(design_other))] + 0.25)
pheatmap(ma)
```
